    ...
    <Dialog open={open} scroll="paper" onClose={onClose} className={classes.dialog}>
      ...
      <DialogContent>
        ...
        <Typography paragraph>
          ...
          functionality. For more general information on cookies see the Wikipedia article on HTTP Cookies.
        </Typography>
        <Typography variant="h6" color="primary" paragraph>
          How We Use Cookies
        </Typography>
        ...
        <Typography paragraph>
          ...
          afterwards to remember your site preferences when logged out. We use cookies to remember that you accepted
          this message.
        </Typography>
        ...
        <Typography paragraph>
          ...
          interact with one of the features you use on our site. This Cookies Policy was created with the help of the
          Cookies Policy Template Generator and the Terms and Conditions Template.
        </Typography>
        <Typography paragraph>
          However if you are still looking for more information then you can contact us by sending an email to
          tim.v.kaenel@gmail.com.
        </Typography>
      </DialogContent>

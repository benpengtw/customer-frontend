...
class RegisterDialog extends PureComponent {
  ...
  render() {
    const { theme, onClose, openTermsDialog, setStatus, status, classes } = this.props
          ...
          <Fragment>
            ...
            {status === 'accountCreated' ? (
              <HighlightedInformation>
                We have created your account. Please click on the link in the email we have sent to you before logging
                in.
              </HighlightedInformation>
            ) : (

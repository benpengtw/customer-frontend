  ...
  return (
    <ExpansionPanel>
            ...
            <ListItem className="listItemLeftPadding" disableGutters divider>
              ...
              <FormControl variant="outlined">
                <ListItemSecondaryAction className={classes.ListItemSecondaryAction}>
                  ...
                  >
                    {['Always', '6 Hours', '12 Hours', '1 Day', '2 Days', '3 Days', '1 Week'].map((element) => (
      ...
      <ExpansionPanelDetails className={classes.expansionPanelDetails}>
        ...
        <Button variant="contained" color="secondary" disabled={isSaveLoading || isDefaultLoading} onClick={onSubmit}>

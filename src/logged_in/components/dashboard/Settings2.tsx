  ...
  const inputs = [
    {
      title: 'Option 1',
      secondaryAction: (
        <Checkbox value="option1" color="primary" checked={option1} onChange={handleCheckboxChange('option1')} />
      ),
    },
    {
      title: 'Option 2',
      secondaryAction: (
        <Checkbox value="option2" color="primary" checked={option2} onChange={handleCheckboxChange('option2')} />
      ),
    },
    {
      title: 'Option 3',
      secondaryAction: (
        <Checkbox value="option3" color="primary" checked={option3} onChange={handleCheckboxChange('option3')} />
      ),
    ...
    },
    {
      title: 'Option 4',
      secondaryAction: (
        <Checkbox value="option4" color="primary" checked={option4} onChange={handleCheckboxChange('option4')} />
      ),
    },
    {
      title: 'Option 5',
      secondaryAction: (
        <Checkbox value="option5" color="primary" checked={option5} onChange={handleCheckboxChange('option5')} />
      ),
    },
    {
      title: 'Option 6',
  ...
  return (
    <ExpansionPanel>
        ...
        <List disablePadding>
          <Bordered disableVerticalPadding disableBorderRadius>
            {inputs.map((element, index) => (
              <ListItem key={index} divider={index !== inputs.length - 1} className="listItemLeftPadding">
                <ListItemText>
      ...
      <ExpansionPanelDetails className={classes.expansionPanelDetails}>
        ...
        <Button variant="contained" color="secondary" onClick={onSubmit} disabled={isSaveLoading || isDefaultLoading}>
